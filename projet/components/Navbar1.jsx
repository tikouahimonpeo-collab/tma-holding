    ...
    >
      <div className="container-tma flex min-h-[72px] items-center justify-between lg:min-h-[84px]">
        ...
        <a href="/" className="flex items-center gap-3">
          <span className="flex h-10 w-10 items-center justify-center rounded-lg bg-tma-night text-white shadow-premium md:h-11 md:w-11">
            <svg viewBox="0 0 40 40" className="h-6 w-6 md:h-7 md:w-7" fill="none">
              <path d="M8 30 L20 10 L32 30 Z" stroke="currentColor" strokeWidth="3" strokeLinejoin="round" />
              <path d="M14 30 L20 20 L26 30 Z" fill="#1E90FF" />
            </svg>
          </span>
          <span className="flex flex-col leading-none">
            <span className="text-lg font-extrabold tracking-tight text-tma-night md:text-xl">
              TMA <span className="text-tma-electric">Holding</span>
            </span>
            <span className="hidden text-[10px] font-medium uppercase tracking-[0.18em] text-tma-ash md:block">
