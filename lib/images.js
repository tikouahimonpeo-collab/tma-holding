...
export const IMAGES = {
  // ============== HEROES ==============
  heroHome: {
    target: "/images/hero/home-construction-premium.webp",
    fallback:
  ...
  heroAbout: {
    target: "/images/hero/about-team-chantier.webp",
    fallback:
  ...
  heroServices: {
    target: "/images/hero/services-montage-metiers.webp",
    fallback:
  ...
  heroShop: {
    target: "/images/hero/shop-catalogue-premium.webp",
    fallback:
  ...
  heroRealisations: {
    target: "/images/hero/realisations-villa-livree.webp",
    fallback:
  ...
  heroDevis: {
    target: "/images/hero/devis-consultation.webp",
    fallback:
      "https://images.unsplash.com/photo-1503387762-592deb58ef4e?auto=format&fit=crop&w=1800&q=80",
  ...
  heroContact: {
    target: "/images/hero/contact-bureau-equipe.webp",
    fallback:
  ...
  // ============== SERVICES ==============
  construction: {
    target: "/images/services/construction/villa-gros-oeuvre.webp",
    fallback:
  ...
  constructionImmeuble: {
    target: "/images/services/construction/immeuble-r5-chantier.webp",
    fallback:
  ...
  renovation: {
    target: "/images/services/renovation/salon-renove-avant-apres.webp",
    fallback:
  ...
  renovationCuisine: {
    target: "/images/services/renovation/cuisine-renovee.webp",
    fallback:
  ...
  peinture: {
    target: "/images/services/painting/airless-mur-blanc.webp",
    fallback:
  ...
  enduit: {
    target: "/images/services/enduit/projection-mecanique.webp",
    fallback:
  ...
  conception: {
    target: "/images/services/conception/plans-rendu-3d.webp",
    fallback:
  ...
  revetement: {
    target: "/images/services/finition/pose-carrelage-premium.webp",
    fallback:
  ...
  importation: {
    target: "/images/services/importation/conteneurs-port-abidjan.webp",
    fallback:
  ...
  // ============== CONTEXTE / AMBIANCES ==============
  villa: {
    target: "/images/context/villa-livree-nuit.webp",
    fallback:
  ...
  immeuble: {
    target: "/images/context/immeuble-facade-livree.webp",
    fallback:
      "https://images.unsplash.com/photo-1545324418-cc1a3fa10c00?auto=format&fit=crop&w=1200&q=80",
  ...
  interieur: {
    target: "/images/context/interieur-salon-premium.webp",
    fallback:
  ...
  chantier: {
    target: "/images/context/chantier-equipe-action.webp",
    fallback:
  ...
  equipe: {
    target: "/images/context/equipe-portrait-chantier.webp",
    fallback:
  ...
  // ============== TMA SHOP — PRODUITS ==============
  carrelage: {
    target: "/images/shop/carreaux/carreaux-ceramique-gris.webp",
    fallback:
  ...
  marbre: {
    target: "/images/shop/carreaux/carreaux-marbre-60x60.webp",
    fallback:
  ...
  sanitaire: {
    target: "/images/shop/sanitaires/vasque-design.webp",
    fallback:
  ...
  salleBain: {
    target: "/images/shop/accessoires-bain/miroir-led.webp",
    fallback:
  ...
  cuisine: {
    target: "/images/shop/cuisines/cuisine-moderne-noir-bois.webp",
    fallback:
  ...
  robinet: {
    target: "/images/shop/robinetterie/mitigeur-chrome.webp",
    fallback:
  ...
  peintureShop: {
    target: "/images/shop/revetements/parquet-stratifie.webp",
    fallback:
  ...
  ciment: {
    target: "/images/shop/materiaux/sac-ciment-cpj425.webp",
    fallback:
  ...
  sable: {
    target: "/images/shop/materiaux/tas-sable-construction.webp",
    fallback:
  ...
  gravier: {
    target: "/images/shop/materiaux/tas-gravier.webp",
    fallback:
  ...
  peintureShopMat: {
    target: "/images/shop/materiaux/pots-peinture-pro.webp",
    fallback:
      "https://images.unsplash.com/photo-1562259949-e8e7689d7828?auto=format&fit=crop&w=1200&q=80",
  ...
  equipement: {
    target: "/images/shop/equipements/machine-projection-enduit.webp",
    fallback:
  ...
  // ============== TÉMOIGNAGES (clients) ==============
  client1: {
    target: "/images/team/client-1.webp",
    fallback:
  ...
  client2: {
    target: "/images/team/client-2.webp",
    fallback:
  ...
  client3: {
    target: "/images/team/client-3.webp",
    fallback:
...
/**
 * Mode de résolution des images.
 *   - "local"    : utilise /public/images/... (assets Nanobanana)
 *   - "fallback" : utilise les URLs Unsplash (placeholders BTP)
 *
 * En mode "local", les entrées marquées `hasLocal: true` retournent
 * leur `target` ; les autres basculent sur `fallback` automatiquement.
 * Basculez ici une fois vos images Nanobanana déposées :
 */
export const IMAGE_MODE = "local";

/** Liste des clés dont l'asset local est bel et bien déposé. */
export const LOCAL_IMAGES = new Set([
  ...
  "peintureShopMat",
  "equipement",
  // Témoignages (2 — client1 absent, reste sur Unsplash)
  "client2",
  "client3",
]);

/** Résout l'URL active d'une image (target local ou fallback). */
export function img(key) {
  const entry = IMAGES[key];
  if (!entry) return "";
  if (IMAGE_MODE === "local" && LOCAL_IMAGES.has(key) && entry.target) {
    return entry.target;
  }
